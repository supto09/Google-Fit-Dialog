...
public abstract class MyBottomSheetDialogFragment extends AppCompatDialog {
    ...
    public MyBottomSheetDialogFragment(@NonNull Context context) {
        this(context, 0);
    }

    public MyBottomSheetDialogFragment(@NonNull Context context, @StyleRes int theme) {
    ...
    protected MyBottomSheetDialogFragment(@NonNull Context context, boolean cancelable,
...
//        // force the dialog to expand over the full screen width
        if (getWindow() != null) {
            getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ScreenUtils.newInstance(getContext()).getHeight());
        }
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ...
        final CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(),
                R.layout.my_design_bottom_sheet_dialog, null);
